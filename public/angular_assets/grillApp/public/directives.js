...
angular.module('qaApp')
    .directive('topQaNav', [function () {
        return {
            templateUrl: 'views/partials/navs/top_qa.html',
    ...
    .directive('bottomQaNav', [function () {
        return {
            templateUrl: 'views/partials/navs/bottom_qa.html',
            link: function ($scope, $element, $attrs) {
            }
        }
    }])
    ...
    .directive('questionModal', [function () {
        return {
            templateUrl: 'views/partials/modals/question_input.html',
            link: function ($scope, $element, $attrs) {
            }
        }
    }])
    .directive('questionFeed', [function () {
        return {
            templateUrl: 'views/partials/questionFeed.html',
            link: function ($scope, $element, $attrs) {
            }
        }
    }])
    .directive('questionFull', [function () {
        return {
            templateUrl: 'views/partials/question_full.html',
            link: function ($scope, $element, $attrs) {
            }
        }
    }])
    .directive('questionEdit', [function () {
        return {
            templateUrl: 'views/partials/modals/question_edit.html',
            link: function ($scope, $element, $attrs) {
            }
        }
    }])
    .directive('commentFull', ['$window', 'socket', 'socketService', 'globals', 'sortObjectToArrayFilter', 'commentService',
        function ($window, socket, socketService, globals, sortObjectToArrayFilter, commentService) {
            return {
                templateUrl: 'views/partials/comment_full.html',
                link: function ($scope, $element, $attrs) {
    ...
    .directive('commentEdit', ['commentService', function (commentService) {
        return {
            templateUrl: 'views/partials/modals/comment_edit.html',
            link: function ($scope, $element, $attrs) {
            }
        }
    }])
    .directive('trendingSummary', [function () {
        return {
            templateUrl: 'views/partials/trending_summary.html',
            link: function ($scope, $element, $attrs) {
            }
        }
    }])
    .directive('trendingFull', [function () {
        return {
            templateUrl: 'views/partials/trending.html',
            link: function ($scope, $element, $attrs) {
            }
        }
    }])
    .directive('onlineFeed', [function () {
        return {
            templateUrl: 'views/partials/online.html',
            link: function ($scope, $element, $attrs) {
            }
        }
    }]);
...
var userSchema = new Schema({
    ...
    ordersIndexes: {type: Array, "default": [], unique: false, index: true},
    orderUniqueIds: {type: Array, "default": [], unique: false, index: true},
    ...
    favouriteOrdersUniqueIds: {type: Array, "default": [], unique: false, index: true},

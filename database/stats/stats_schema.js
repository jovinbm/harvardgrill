...
var statsSchema = new Schema({
    ...
    timeId: {type: String, required: true, default: "abcde", unique: true, index: true},
    currentOrderIndex: {type: Number, default: 0, required: true, unique: false, index: true},
    ...
    totalUnattendedOrders: {type: Number, default: 0, required: true, unique: false, index: true}
});
